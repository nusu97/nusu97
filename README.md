...
I am a **Computer Science** student with a **Minor in Mathematics** at **Toronto Metropolitan University**. I specialize in building high-performance technology that is both inclusive and user-centric.

- 🎓 **Education:** B.Sc. in Computer Science (Dean's List).
- 🤟 **Passion:** Bridging the gap between technology and accessibility, inspired by my training in **American Sign Language**.
